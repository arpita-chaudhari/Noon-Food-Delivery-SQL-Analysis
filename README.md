...
3. Identified **single-order customers acquired in January 2025**.
4. Found **inactive customers** who were acquired through promotions.
5. Identified customers after their **every third order**.
...
│
├── sql/
│   └── noon_food_delivery_analysis.sql
│
└── README.md
```
